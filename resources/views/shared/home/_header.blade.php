            ...
            <div class="col-auto col-lg-1 d-flex justify-content-end ps-0">
                <div class="accordion accordion-flush" id="languagesTopics">
                    <div class="accordion-item">
                        ...
                        <div id="flush-languages" class="accordion-collapse collapse text-justify align-items-center border" aria-labelledby="flush-languages-header" data-bs-parent="#languagesTopics">
                            @foreach($languages as $language)
                                <form method="post" class="mt-2" action="{{ route('change-language', $language) }}" data-turbo="false" data-controller="form">
                                    @csrf
                                    <label class="form-selectgroup-item">
                                        <input type="radio" name="language" value="{{$language->name}}" class="form-selectgroup-input"/>
