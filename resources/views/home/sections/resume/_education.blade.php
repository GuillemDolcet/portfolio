...
<p class="mb-2">{{ $educationModel->school }} / {{$educationModel->start_date->format('Y')}} - {{ !is_null($educationModel->finish_date) ? $educationModel->finish_date->format('Y') : Lang::get('admin.currently') }}</p>
