<section id="{{ $section->name }}" class="section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 text-center text-lg-start wow" data-animation="fadeInUp" data-delay="0,3">
                {!! $section->description !!}
            </div>
            @if(count($experiences) > 0)
                <div class="col-lg-4 mt-4 mt-lg-0 wow" data-animation="fadeInUp" data-delay="0,3">
                    <div class="featured-box style-4">
                        <div class="text-25 fw-500 text-black">
                            <span class="wow heartBeat" data-wow-delay="1.3s">
                                {{ round(\Carbon\Carbon::now()->diffInMonths($experiences->sortBy('start_date')->first()->start_date) / 12) * -1 }}
                            </span>
                        </div>
        ...
        <div class="row gy-3 mt-4">
            <div class="col-12 col-lg-6 col-sm-6 wow" data-animation="fadeInUp" data-delay="0,3">
            ...
            <div class="col-12 col-lg-6 col-sm-6 wow" data-animation="fadeInUp" data-delay="0,4">
