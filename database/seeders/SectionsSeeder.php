...
class SectionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $this->sections->create([
            ...
            'description' => [
                'es' => "<h2 class='text-8 fw-400 mb-3'>Hi, I'm <span class='fw-700 border-bottom border-3 border-primary'>Guillem Dolcet</span></h2><p class='text-5'>I'm a designer & developer with a passion for web design. I enjoy developing simple, clean and slick websites that provide real value to the end user. Thousands of clients have procured exceptional results while working with me. Delivering work within time and budget which meets client’s requirements is our moto.</p>",
                'en' => "<h2 class='text-8 fw-400 mb-3'>Hola, soy <span class='fw-700 border-bottom border-3 border-primary'>Guillem Dolcet</span></h2><p class='text-5'>Soy un diseñador y desarrollador apasionado por el diseño web. Disfruto desarrollando sitios web sencillos, limpios y elegantes que aporten un valor real al usuario final. Miles de clientes han conseguido resultados excepcionales trabajando conmigo. Entregar el trabajo a tiempo y dentro del presupuesto que cumpla con los requisitos del cliente es nuestra moto.</p>",
            ]
        ]);
