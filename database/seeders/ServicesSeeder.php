    ...
    public function run(): void
    {
        $this->services->create([
            'title' => [
                ...
                'ca' => 'Aplicacions web personalitzades',
            ],
            'description' => [
                ...
                'ca' => "Solucions web úniques i a mida que s'ajusten perfectament als requisits específics del teu negoci. Des de portals corporatius fins a plataformes de comerç electrònic, t'ofereixo un desenvolupament àgil i eficient utilitzant Laravel i PHP, garantint aplicacions robustes, escalables i segures.",
            ],
        ...
        $this->services->create([
            'title' => [
                ...
                'ca' => 'Manteniment i actualització de webs',
            ],
            'description' => [
                ...
                'ca' => "Mantén el teu lloc web al dia, segur i en perfecte funcionament amb els meus serveis de manteniment i actualització. Inclou la implementació de les últimes característiques de seguretat, millora de la funcionalitat existent, i optimització de la velocitat del lloc per a una millor experiència d'usuari.",
            ],
        ...
        $this->services->create([
            'title' => [
                ...
                'ca' => 'Desenvolupament i integració d\'APIs',
            ],
            'description' => [
                ...
                'ca' => "Desenvolupament i integració d'APIs RESTful personalitzades. Aquestes APIs són essencials per a aplicacions mòbils, integracions de tercers i automatitzacions, assegurant que el teu servei pugui créixer i adaptar-se a noves necessitats.",
            ],
